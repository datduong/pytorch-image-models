...
train_name='20200824-144916-efficientnet_b0-224'
output=$base_path/$train_name/result_test.csv # path/name.csv
checkpoint=$base_path/$train_name/model_best.pth.tar

python3 validate_no_label.py $data_path --model efficientnet_b0 -b $batchsize -j 4 --num-classes 7 --results-file $output --checkpoint $checkpoint --amp --use-ema --average_augment 
#--create_classifier_layerfc
