...
train_name='20200827-192715-efficientnet_b0-450'
...
python3 validate_no_label.py $data_path --model efficientnet_b0 -b $batchsize -j 2 --config $base_path/$train_name/args.yaml --num-classes 7 --results-file $output --checkpoint $checkpoint --amp --use-ema --no-test-pool
