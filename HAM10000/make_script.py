...
script_base_array = [ 'inception_v3' ] #  'efficientnet_b0' , 'efficientnet_b1', 'efficientnet_b2' 
LR = [0.001]
...
for script_base in script_base_array: 
  for dropout in [0.2] : # [0.1,0.3]: 
    for index, val in enumerate(LR) :
      ...
      #
      time.sleep(3)
      os.system ( 'sbatch --partition=gpu --time=2-12:00:00 --gres=gpu:p100:1 --mem=10g -c4 ' + foutname ) # k80
