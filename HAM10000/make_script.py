...
python3 train.py $data_path --model MODEL-NAME -b $batchsize --sched step --epochs 450 --decay-rate 0.5 --opt nadam -j 6 --warmup-lr 1e-6 --weight-decay 0 --last_layer_weight_decay 0.0001 --drop DROPOUT --drop-connect DROPOUT --model-ema --model-ema-decay 0.9999 --aa ISIC2020 --vflip 0.5 --remode pixel --reprob 0 --amp --lr LEARNING-RATE --classification_layer_name 'classifier' --filter_bias_and_bn --pretrained --num-classes 7 --topk 2 --output $output --weighted_cross_entropy '30 19 9 87 8 1 70' --create_classifier_layerfc --scale 0.1 1.0 --eval-metric loss --sampler ImbalancedDatasetSampler
