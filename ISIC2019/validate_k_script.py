...
base_path=/data/duongdb/ISIC2019-SkinCancer8Labels/TrainDevTestRandState1/timm-setting/
...
python3 validate_no_label.py $data_path --model efficientnet_b0 -b $batchsize -j 2 --config $base_path/$train_name/args.yaml --num-classes 9 --results-file $output --checkpoint $checkpoint --amp --use-ema --no-test-pool --has_eval_label

"""

os.chdir('/data/duongdb/ISIC2019-SkinCancer8Labels/TrainDevTestRandState1/timm-setting/')

case = {1: '20200905-004911-efficientnet_b0-224', 
        2: '20200905-004921-efficientnet_b0-224',
        3: "20200905-004915-efficientnet_b0-224", 
        4: '20200905-004915-efficientnet_b0-224'}

for k, val in case.items() : 
  base2 = re.sub('TRAIN_NAME',str(k)+'/train/'+val,base) # train/
